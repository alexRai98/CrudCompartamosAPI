...
func (c *ConnectionMongo) ConnectMongoDb() (*mongo.Client, error) {
	...
	credential := fmt.Sprintf("mongodb+srv://rai_98:%s@crudcomportamos.9rlbg78.mongodb.net/?retryWrites=true&w=majority&appName=crudComportamos", os.Getenv("PSS-MONGO"))
